...
Feature: Document shareholder
  ...
  Scenario Outline: Should Create all types document for shareholder
    Given a PJ profile
    When I have linked a shareholder
    When create a shareholder document of the type "<type>"
  ...
  Scenario: Should Create document and file for shareholder
    Given a PJ profile
    When I have linked a shareholder
    When create a shareholder document of the type "BUREAU_PROOF_OF_ADDRESS"
    When add the file in shareholder
